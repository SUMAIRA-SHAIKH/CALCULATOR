...
let id: Number= 11709;
let stdname:string= "Sumaira Aziz"
console.log(`\n\t created by '${stdname}' \t\t \tID: '${id}'`);

console.log("\t\t\t***~SIMPLE CALCULATOR~***");
console.log("\t\t\t=========================\n");

async function performCalculation() {    //using async function
const answer = await inquirer.prompt([                      // taking input from user
...
const output = await inquirer.prompt([          //2nd input for do want to continue calculation or not?
